...
them.  For example, the book has gone into some detail on recursive and iterative algorithms, and how they are executed by the interpreter.
Terminology I didn't know I needed has been clarified, like the difference between a recursive [REF ALGORITHM?] and a recursive process.
