...
I perform a lot of one-shot analysis and need to know it's right.

*logo pinched from [r-bloggers.com](https://www.r-bloggers.com/), great site, you should check it out*
...
```
*The example above adapted from [How to Automate Data Quality Checks with R](https://www.statology.org/how-to-automate-data-quality-checks-r/) by Jayita Gulati.*
